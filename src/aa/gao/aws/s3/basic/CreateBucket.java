...
2） AmazonS3 s3client = AmazonS3ClientBuilder.standard().withRegion(Regions.AP_NORTHEAST_1.getName()).build(); 
 */
...
//        s3client.setRegion(Region.getRegion(Regions.AP_NORTHEAST_1));
//        AmazonS3 s3client = AmazonS3ClientBuilder.standard().withRegion(Regions.AP_NORTHEAST_1.getName()).build();
